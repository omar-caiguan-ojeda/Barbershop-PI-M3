// Iconos SVG para Facebook, Instagram, TikTok y WhatsApp
...
export function InstagramIcon({ size = 26 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <radialGradient id="igpaint0_radial" cx="0" cy="0" r="1" gradientTransform="translate(16 16) scale(16)" gradientUnits="userSpaceOnUse">
        <stop stopColor="#FFD676"/>
        <stop offset="0.5" stopColor="#FCA7B6"/>
        <stop offset="1" stopColor="#A069E7"/>
      </radialGradient>
      <rect x="4" y="4" width="24" height="24" rx="8" fill="url(#igpaint0_radial)"/>
...
export function TikTokIcon({ size = 26 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
